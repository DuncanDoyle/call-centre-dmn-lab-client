...
public class Main {
	...
	private static final String DMN_MODEL_NAMESPACE = "https://github.com/kiegroup/drools/kie-dmn/_E5C7F40E-CF45-451C-B3F4-6B0C97A1B131";
	
	private static final String DMN_MODEL_NAME = "call-centre";
	
	private static final String CONTAINER_ID = "call-centre-decision_1.0.0-SNAPSHOT";
